...
class textToSpeechEx:
    def __init__(self):
        ...
        self.themes=[self.summer, self.fall, self.winter, self.spring, self.fun, self.interesting]
        self.speech = speech()
    ...
    def randomQuesGenerator(self):
        ...
        while(not correctAnswer):
            try:
                ...
                self.speech.speak('Please say an integer')
